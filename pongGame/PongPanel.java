...
public class PongPanel extends JPanel implements ActionListener, KeyListener{
    ...
    public void paintComponent(Graphics g){
        ...
        if (showTitleScreen) {
            ...
            int playerOneRight = playerOneX;//TODO: + playerOneWidth;
            ...
            g.drawLine(getWidth() - playerOneRight +5, 0, getWidth() - playerOneRight, getHeight());
            g.drawLine(getWidth() - playerTwoLeft -5, 0, getWidth() - playerTwoLeft, getHeight());
            
            //draw the scores
            g.setFont(new Font(Font.DIALOG, Font.BOLD, 36));
            g.drawString(String.valueOf(playerOneScore), getWidth() - 100, 100);
            g.drawString(String.valueOf(playerTwoScore), getWidth() - 400, 100);

            //draw the ball
            g.fillOval(ballX, ballY, diameter, diameter);

            //draw the paddles
            g.fillRect(getWidth() - playerTwoX, playerOneY, playerOneWidth, playerOneHeight); 
            g.fillRect(getWidth() - playerOneX, playerTwoY,playerTwoWidth, playerTwoHeight);
        }
        else if (gameOver) {
